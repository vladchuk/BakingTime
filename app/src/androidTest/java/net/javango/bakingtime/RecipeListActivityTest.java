...
public class RecipeListActivityTest {
    ...
    public void clickItem_OpensStepsActivity() {
        ...
        onView(nthChildOf(withId(R.id.ingredient_list), 0)).check(matches(withText(containsString("Bittersweet chocolate"))));
    }

    /**
     * From StackOverflow post at https://stackoverflow.com/questions/38773804/espress-accessing-nth-child-element-of-linear-layout
     */
